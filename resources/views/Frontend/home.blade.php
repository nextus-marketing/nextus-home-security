                    ...
                    <div class="tp-about-wrapper tp-about-wrapper-2 pt-40 mb-40 pr-40">
                        ...
                        <div class="tp-about-fea-signature d-flex align-items-center mt-25">
                            <div class="sig-btn mr-30 mb-10">
                                <a class="tp-btn-border" href="tel:+18558743165"> <i class="fa-solid fa-phone"></i> Call Our
                                    Security Expert
            ...
            <div class="row text-center">
                <div class="col-12">
                    <div class="tp-section-box tp-section-box-2 p-relative mb-45">
                        ...
                        <p>At Nextus Home Security, we offer expert security solutions tailored to protect what matters most.
    ...
    <div class="team-details-area pt-80 pb-20">
        <div class="container">
                    ...
                    <div class="team-info-main pt-0 pl-45">
                        <div class="team-details-info">
                            ...
                            <p>With over 15 years of expertise in the field, we have been committed to delivering the best
                                in security and automation solutions. Nextus Home Security has consistently ranked among the top
                        ...
                        <div class="sig-btn mr-30 mb-10">
                            <a class="tp-btn-border" href="tel:+18558743165"> <i class="fa-solid fa-phone"></i> Talk To
                                Security Expert
                                <i class="fal fa-long-arrow-right"></i></a>
                        </div>
                    </div>
            ...
            <div class="row">
                <div class="col-xl-6">
                    <div class="team-member">
                        <img src="/frontend/my_img/why_choose.png" alt="Why Choose Nextus Home Security">
                    </div>
                    </br>
                </div>
                <div class="col-xl-6">
                    <div class="team-info-main pt-0 pl-45">
                        <div class="team-details-info mt-3">
                            ...
                            <h5>Why Choose Nextus Home Security
                            </h5>
                        ...
                        <div class="sig-btn mr-30 mb-10">
                            <a class="tp-btn-border" href="tel:+18558743165"> <i class="fa-solid fa-phone"></i> Call Now
            ...
            <div class="col-xl-8 col-lg-10 m-auto">
                ...
                <div class="tpsupport-wrapper d-flex justify-content-center">
                    ...
                    <div class="tpsupport-ovr-button me-3">
                        <a class="tp-btn" href="tel:+18558743165">
